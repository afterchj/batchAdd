...
<body>
	<div class="container-fluid">
		...
		<div class="row-fluid" style="margin-top: 10px;">
			...
			<div id="high" class="row-fluid"
				style="text-align: center; ">
				<form method="post" action="highpirce_confirm"
					enctype="multipart/form-data">
					<h1>高价任务上传EXCEL:</h1>
					<br> <input type="file" name="file" /> <input type="submit"
						value="确认文件" />
					<span class="required" style="position: absolute;left: 1500px;top: 134px" id="message">${hpMessage}</span>
				</form>
			</div>
		</div>
	</div>
